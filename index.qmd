...
function detailFormatter(index, row) {
    var excludeFields = ['timetamp', 'mentor_id', 'status', 'major', 'internship_experience', 'internship_details', 'selected'];
    var html = [];
...
$('#mentor-table').on('check.bs.table', function (e, r, elt) {
  ...
  // Add 'selected' class to next detailView
  // console.log(elt);
  // let nextElt = elt[0].parentElement.parentElement.parentElement.nextElementSibling;
  // if (nextElt.classList.contains("detail-view")) {
  //   nextElt.classList.add("selected");
  // }
...
$('#mentor-table').on('uncheck.bs.table', function (e, r, elt) {
  ...
  // Remove 'selected' class to next detailView
  // let nextElt = elt[0].parentElement.parentElement.parentElement.nextSibling;
  // if (nextElt.classList.contains("detail-view")) {
  //   nextElt.classList.remove("selected");
  // }
  // And update the sidebar
  updateSidebar();
});
